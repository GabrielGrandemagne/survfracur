...
#' @docType data
#' @keywords datasets
#' @description A simulated data frame with 400 individuals. Simulated dataset that mimic a kidney result study. In this simulated dataset it is hypothetically suggested the following causes of outcome: event of interest: death due to kidney failure; dependent censoring: if the patient received a transplant; administrative censoring: all other outcomes.
...
#'   \item x1_cure: covariate 1, generated from a Uniform Distribution. Can denote, for example, a exam result.
#'   \item x_c1: covariate 2, generated from a Binomial Distribution. Can denote, for example, an treatment
#'   \item x_c2: covariate 3, generated from a Normal Distribution. can denote, for example, an standardized age.
